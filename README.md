...
This repository contains the script necessary to produce the figures in the publication titled _"Flow dynamics in a CO2 microwave plasma inferred from in-situ diagnostics and conservation laws"_.
...
3. Run the Jupyter notebooks to reproduce the figures. The recommended way to do this is to open the notebooks in VSCode and run the cells there.
